        ...
        <div className="container lg:max-w-4xl">
          ...
          <div className="space-y-6 text-body-md">
            <p>
              ...
              tecnologia precisam considerar ao desenvolver soluções nesta área.
              área.
            </p>
            <p>
              Questões relacionadas ao sigilo médico, segurança de dados,
              consentimento informado e equidade no acesso aos serviços são
              fundamentais para garantir que a tecnologia beneficie pacientes e
          ...
          >
            ...
            <p className="text-body-sm">
              ...
              Os resultados apresentados são baseados em suas respostas e servem
              como ponto de reflexão inicial sobre dilemas éticos.
            </p>
          </div>
        </div>
      </section>
